...
/** The view Controller to which the EAGLView has been attached */
@property (readonly,assign) UIViewController* viewController;
...
/** attach in UIView of a UIViewController using the full frame */
-(BOOL)attachInViewOfViewController:(UIViewController *)viewController;

/** attach in UIView of a UIViewController using the given frame */
-(BOOL)attachInViewOfViewController:(UIViewController *)viewController withFrame:(CGRect)frame;
